  ...
  const [show,setShow] = useState (true);
    ...
    const handleSubmit = async (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            props.editRO(id,{newState:"DELIVERED"},restockOrder);
            setId(0);
            setValidated(false);
        }    
    };
        ...
        <div className="Registration" >
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit} className="pt-5">
                <Row className="justify-content-center">
                    <h2 className='text-center'> Accept Restock Order </h2>
                </Row>
                <Row>
                    <Col xs={2} />
                    <Col xs={8}>
                ...
                <Row>
                    ...
                    <Col md={1} xs={3} className="pl-5">
                        <Button variant="warning" color="black" id="submitButton" type="submit" className="float-right ">Accept Restock Order </Button>
                    </Col>
                    <Col md={3} xs={2}/>
                </Row>
            </Form >
